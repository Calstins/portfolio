      ...
      <div className="container mx-auto flex flex-col items-center xl:flex-row gap-x-6 md:w-[1024px]">
        ...
        <div className="flex-1 flex flex-col justify-center mb-4">
          ...
          <motion.p
            ...
            animate="show"
            initial="hidden"
            className="max-w-[500px] mx-auto xl:mx-0 xl:mb-12 px-2 xl:px-0 text-[13px] lg:text-base"
          >
            Hi there!
            <br />5 years ago, I began freelancing as a developer, Since then,
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {aboutData[selectedTabIndex].info.map((item, index) => {
              return (
                <div
                  key={index}
                  className="flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/60 lg:text-base text-[12px]"
                >
                  ...
                  <div className="flex gap-x-4">
                    {item.icons?.map((icon, index) => {
                      return (
                        <div key={index} className="text-l text-white">
                          {icon}
                        </div>
                      );
                    })}
