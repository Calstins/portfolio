  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 relative">
        <div className="text-center flex flex-col justify-center xl:pt-40 pt-20 xl:text-left h-full container mx-auto">
          {/* title */}
          <motion.h1
          ...
          >
            Unlocking the Future: Crafting Seamless Digital Experiences &ndash;
            A Fullstack Developer&apos;s Journey into the Digital Realm &nbsp;
          </motion.p>
          {/* btn */}
