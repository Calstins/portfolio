...
const ProjectsBtn = () => {
  return <div className='mx-auto xl:mx-0 mb-20'>
      <Link href={'/work'} className='relative w-[185px] h-[185px] flex justify-center items-center bg-circleStar bg-cover bg-center bg-no-repeat group'>
        <img 
          src={'/rounded-text.png'} alt="" className='animate-spin-slow w-full h-full max-w-[141px] max-h-[148px]' height={148} width={141}
        />
        <HiArrowRight 
